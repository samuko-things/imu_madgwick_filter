...
void ImuMadgwickFilter::madgwickAHRSupdate(float gx, float gy, float gz, float ax,
...
void ImuMadgwickFilter::madgwickAHRSupdateIMU(float gx, float gy, float gz, float ax,
                                      float ay, float az)
{
    float s0, s1, s2, s3;
    float qDot1, qDot2, qDot3, qDot4;
...
void ImuMadgwickFilter::getGravity(float& rx, float& ry, float& rz, float gravity)
{
